...
int main()
{
	...
	if (RESULTS_TO_FILE) {
		pointCount.open(
				"/home/hrvoje/Desktop/Lucas Kanade algorithm/developing_LK/test_images/testSequence4/results/old_pointCount.txt",
				std::ofstream::out | std::ofstream::trunc);
		avgMagErr.open(
				"/home/hrvoje/Desktop/Lucas Kanade algorithm/developing_LK/test_images/testSequence4/results/old_avgMagErr.txt",
				std::ofstream::out | std::ofstream::trunc);
		avgAngErr.open(
				"/home/hrvoje/Desktop/Lucas Kanade algorithm/developing_LK/test_images/testSequence4/results/old_avgAngErr.txt",
				std::ofstream::out | std::ofstream::trunc);
		time.open(
				"/home/hrvoje/Desktop/Lucas Kanade algorithm/developing_LK/test_images/testSequence4/results/old_time.txt",
				std::ofstream::out | std::ofstream::trunc);
